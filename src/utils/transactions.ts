...
export const ERROR_MAP = {
  ...
  SIG_FAILED:
    "Signing message failed. Make sure you are not connected to a hardware wallet.",
  ...
  INVALID_INPUT:
    "Missing or invalid parameters. Make sure you used the correct parameters.",
  RESOURCE_NOT_FOUND: "Requested resource not found. Please contact with team.",
  RESOURCE_NOT_AVAILABLE:
    "Requested resource not available. Make sure the wallet dialog is already open.",
  ...
  JSON_RPC_NOT_SUPPORT:
    "Version of JSON-RPC protocol is not supported. Please contact with team.",
  INVALID_REQUEST: "JSON is not a valid request object.",
  METHOD_NOT_FOUND: "Method does not exist.",
  INVALID_PARAMS:
    "Invalid method parameters. Make sure you used the correct method parameters.",
