...
export const CREATE_BID_TX = gql`
    mutation CreateBidTx($buyerAddress: String!, $token: String!, $price: Float!) {
...
export const CREATE_CONFIG = gql`
    mutation createConfig($config: Anything!, $owner: String!, $workspace: String!, $signature: String!, $type: String!, $domain: String) {
        createConfig(config: $config, owner: $owner, workspace: $workspace, signature: $signature, type: $type, domain: $domain)
    }
`;
