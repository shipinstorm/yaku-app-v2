  ...
  query GetProjectStats(
    ...
    getProjectStats(
      condition: {
        ...
        excludeProjectAttributes: $excludeProjectAttributes
        tags: $tags
        is_verified: true
      }
      chain: $chain
...
export const GET_MP_ACTIVITIES = gql`
  query GetMPActivities(
    $condition: GetMPActivitiesCondition
...
export const GET_NMP_ACTIVITIES = gql`
  query GetNonMpaActivities(
    $condition: GetNonMPActivitiesCondition
    $paginationInfo: PaginationConfig
  ) {
...
export const GET_USER_LISTINGS = gql`
  query GetUserListings(
    $condition: GetUserListingsCondition
    $orderBy: OrderConfig
  ) {
...
export const GET_PROJECT_NAME = gql`
  query GetProjectStats($projectIds: [String], $chain: String) {
    getProjectStats(
      condition: { projectIds: $projectIds, is_verified: true }
      chain: $chain
    ) {
      project_stats {
        project_id
...
export const GET_TOKEN_STATE = gql`
  query GetTokenState(
    $condition: GetTokenStateCondition
    $paginationInfo: PaginationConfig
  ) {
