...
export const STAKING_REWARD_MINT = 'AqEHVh8J2nXH9saV2ciZyYwPpqWFRfD2ffcq5Z8xxqm5';
...
export const TOKEN_ACC_SOLSCAN_API_ENDPOINT = 'https://proxy.yaku.ai/api/ss/account/tokens';
...
export const YAKU_TOKEN_EXCLUDE_WALLET = ['BSiVHe9kfGB56uCoFG2e8ZDMXdroYDMCQ532WdWFstRa', 'EGYXQuorkuGajMNt2UybASq7NsCpWrtFgwNUX7MyM1hx'];
...
export const RPC_LIST = ['https://gateway.yaku.ai/rpc/0', 'https://mainnet.helius-rpc.com/?api-key=0c10bba8-1e7d-438c-95f0-eab06a7f3d94'];
export const DEFAULT_RPC = RPC_LIST[0];
export const DEFAULT_RPC_WS = 'wss://virulent-icy-darkness.solana-mainnet.quiknode.pro/02db76ea26aebfe00b1557d88462e7e398356139/';
...
export const LOGO_BLACK = 'https://s3.amazonaws.com/img.yaku.ai/logos/Logo2K.png';
