...
const StatusBar: React.FC<Props> = ({ tx, isPanelShown, onToggle }) => {
    ...
    const { data: mintInfo } = useRequest(() => getMintInformation(connection, tx.mint));
    ...
    return (
        <div className="tx-status-bar flex justify-between">
                ...
                <span className="description-info flex items-center">
                    {tx.mint && !!mintInfo && (
                        <div className="flex items-center mr-3">
                            <img src={mintInfo.image} alt={mintInfo.symbol} className="mint-img mr-2" />
                    ...
                    <div className="description ml-2">
                        {targetAddress !== '' ? (
                            <div className="flex">
                                Recipient: <PubkeyLink customClass="ml-2" pubkey={targetAddress} />
                            </div>
                        ) : (
                            tx.description ?? ''
                        )}
            ...
            <div className="toggle-panel">
                ...
                <Button variant="contained" color="primary" onClick={onToggle} className="p-2 min-w-[40px] rounded-xl">
