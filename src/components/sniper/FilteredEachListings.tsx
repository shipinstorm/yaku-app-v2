          ...
          >
                  ...
                  >
                    <Typography
                      ...
                      sx={{
                        ...
                        lineHeight: "18px",
                        color:
                          rarityColorCode[NFTData?.rankingInfo?.rankingCategory]
                            ?.color,
                      }}
                    >
            ...
            >
              ...
              >
                ...
                >{`FP: ${
                  NFTData.listingInfo.collection in fp
                    ? String(fp[NFTData.listingInfo.collection].fp)
                    : "N/A"
                }`}</Typography>
              </Box>
              {/** PRICE END */}
                ...
                <Button
                  ...
                  onClick={() =>
                    buyNow(
                      NFTData?.MEData,
                      NFTData?.timeListed +
                        NFTData?.MEData?.tokenMint +
                        String(NFTData?.MEData?.price)
                    )
                  }
                >
