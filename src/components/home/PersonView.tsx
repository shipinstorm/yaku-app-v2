        ...
        <>
            <Grid container columnSpacing={1} rowSpacing={1} sx={{ my: 1 }} justifyContent="space-between" alignItems="center">
                ...
                >
                    ...
                    <p className="text-lg font-bold">{numberFormatter(followersCount, 0)}</p>
                </Grid>
                {nftCount && (
                    <Grid item xs={6} className="!p-0" display="flex" flexDirection="column" justifyContent="center" alignItems="center">
                        <Typography component="p" className="text-terciary font-bold text-[14px]">
                            NFT count
                        </Typography>
