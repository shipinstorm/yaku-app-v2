...
import { Dialog, DialogContent, DialogTitle, TextField, ToggleButton, ToggleButtonGroup, Typography } from '@mui/material';
            ...
            <DialogContent>
                <DialogTitle>
                    ...
                    <Typography fontSize={14} sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
                        Set up your preferable priority fee to boost the transaction. (High priority fee only make the transaction proceed
                        with a higher priority, but no guarantee on successfulness. The Priority options may be lower than market rate,
                        please feel free to adjust your priority rate base on network congestion rate.)
                    </Typography>
                </DialogTitle>
                <MainCard border={false} sx={{ p: 1, backgroundColor: '#09080d' }}>
                    ...
                    <Typography fontSize={12} sx={{ display: 'flex', gap: 1, alignItems: 'center' }}>
                        Priority rate is in microLamports, 1 microLamport equals to 0.00000001 Lamports. 1 Lamport equals to 0.00000001 Sol.
                    </Typography>
                </MainCard>
            </DialogContent>
        </Dialog>
