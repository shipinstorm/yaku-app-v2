...
export const claimReward = async (
  ...
  const srcYakuTokenAccount = await getAssociatedTokenAccount(
    globalAuthority,
    YAKU_TOKEN_MINT
  );
  const claimerYakuTokenAccount = await getAssociatedTokenAccount(
    userAddress,
    YAKU_TOKEN_MINT
  );
...
export const getRaffleKey = async (
  ...
  let poolAccounts = await connection.getParsedProgramAccounts(
    program.programId,
    {
      filters: [
        {
